defmodule Tunez.Albums.FormLive do
  ...
  def mount(%{"id" => album_id}, _session, socket) do
    album =
      Music.get_album_by_id!(album_id,
        load: [:artist, tracks: [:duration]],
        actor: socket.assigns.current_user
      )

    form =
      Music.form_to_update_album(album, actor: socket.assigns.current_user)
