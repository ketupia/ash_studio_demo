...
config :ash_studio_demo, AshStudioDemoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AshStudioDemoWeb.ErrorHTML, json: AshStudioDemoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AshStudioDemo.PubSub,
  live_view: [signing_salt: "3JBU2SaQ"]
...
config :ash_studio_demo, AshStudioDemo.Mailer, adapter: Swoosh.Adapters.Local
